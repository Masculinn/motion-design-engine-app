...
import animations from '../../../src/components/lib/animate.lib';
import transitions from '../../../src/components/lib/transitions.lib';
import { cn } from '../../lib/utils';
import { useAnimationMixer } from './hooks/use-animation-mixer';
import { AnimationObjProps, TransitionConfig, ViewAnimationControllerProps } from './types';
 ...
 */
const MotionContainer = dynamic(() => Promise.resolve(memo(Container as typeof Container)), {
  ssr: false,
});
